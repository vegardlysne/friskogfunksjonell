...
Les mer om [den vitenskapelige metode](brokenlink/vitenskapelig-metode/ "Den vitenskapelige metode").
...
-   [Kildekritikk](brokenlink/kildekritikk/ "Kildekritikk – hva er en god kilde?")

-   [Ikke tro alt du leser!](brokenlink/ikke-tro-alt-du-leser/ "Ikke tro alt du leser!")

-   [Publikasjonsprosessen](brokenlink/publikasjonsprosessen/ "Publikasjonsprosessen")

Forskning publiseres i vitenskapelige tidsskrifter, som man vanligvis må betale for tilgang til. De siste årene har imidlertid [Open Access](brokenlink/open-access/ "Open Access") skutt i været, og mer og mer forskning publiseres nå på denne måten.
...
-   [Signifikans og alt det der](brokenlink/signifikans-og-alt-det-der/ "Signifikans og alt det der")

-   [Å tolke en studie i kontekst](brokenlink/studie-kontekst/ "Å tolke en studie i kontekst")
...
-   [Full kontroll?](brokenlink/full-kontroll/ "Full kontroll?")

-   [Soyaprotein, østrogen og uteliggere – Hvorfor du skal være obs på feilkilder](brokenlink/soyaprotein-ostrogen-og-uteliggere-hvorfor-du-skal-vaere-obs-pa-feilkilder/ "Soyaprotein, østrogen og uteliggere – Hvorfor du skal være obs på feilkilder")

-   [Helsebevisste individer - en forstyrrende faktor i forskningen?](brokenlink/helsebevisste-individer/ "Helsebevisste individer – en forstyrrende faktor i forskningen?")

-   [Konfunderende faktorer](brokenlink/konfunderende-faktorer/ "Konfunderende faktorer")

-   [Mer om konfunderende faktorer](brokenlink/mer-om-konfunderende-faktorer/ "Mer om konfunderende faktorer")

-   [Svakheter i ernæringsepidemiologi](brokenlink/ernaeringsepidemiologi/ "Svakheter i ernæringsepidemiologi")

-   [Er forskning til å stole på?](brokenlink/er-forskning-til-a-stole-pa/ "Er forskning til å stole på?")

-   [Forskning - er større alltid bedre?](brokenlink/forskning-er-storre-alltid-bedre/)
...
-   [Inkompetent uten å vite det - Dunning-Kruger-effekten](brokenlink/inkompetent-uten-a-vite-det-dunning-kruger-effekten/ "Inkompetent uten å vite det – Dunning-Kruger-effekten")

-   [Rådgiver - Kjenn dine begrensninger!](brokenlink/kjenn-dine-begrensninger/ "Rådgiver – kjenn dine begrensninger!")
...
-   [Bekreftelses- og tilgjengelighetsbias](brokenlink/tankefeil-del-1-bekreftelse-og-tilgjengelighet/ "Tankefeil del 1 – Bekreftelse og tilgjengelighet")

-   [Etterpåklokskap og rammeeffekten](brokenlink/tankefeil-del-2-etterpaklokskap-og-rammeeffekten/ "Tankefeil del 2 – Etterpåklokskap og rammeeffekten")

-   [Fundamental attribusjonsfeil](brokenlink/tankefeil-del-3-fundamental-attribusjonsfeil/ "Sosiale bias – Fundamental attribusjonsfeil")
