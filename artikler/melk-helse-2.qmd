...
Samtidig kan pasteuriseringsprosessen også påvirke [bioaktive peptider](peptider-helse.qmd) som kan brytes ned ved oppvarming. Når karbohydrater og proteiner reagerer med hverandre under varmebehandling kan det også oppstå uheldige produkter, noe som spesielt er aktuelt for smakssatt melk (3). Dette skyldes at sukkermolekyler kan reagere med proteinene(4). Pasteurisering brukes også for å øke holdbarheten på melken, og er således en konserveringsmetode (2).
