...
Sist gang  gikk vi i dybden på [melkens innhold av næringsstoffer](melk-helse-1.qmd "Melk og helse del 1 – næringsinnhold"). Denne gangen skal jeg se nærmere på hvordan melken behandles fra den forlater kuen og til den dukker opp i kjøledisken i butikken. Dette er viktig både for hvordan produktet oppleves av oss som skal drikke dem, men også av hensyn til mattryggheten.
...
Samtidig kan pasteuriseringsprosessen også påvirke [bioaktive peptider](http://www.friskogfunksjonell.no/peptider-og-helse/ "Peptider og helseeffekt – er det likegyldig hvilke proteiner vi spiser?") som kan brytes ned ved oppvarming. Når karbohydrater og proteiner reagerer med hverandre under varmebehandling kan det også oppstå uheldige produkter, noe som spesielt er aktuelt for smakssatt melk (3). Dette skyldes at sukkermolekyler kan reagere med proteinene(4). Pasteurisering brukes også for å øke holdbarheten på melken, og er således en konserveringsmetode (2).
