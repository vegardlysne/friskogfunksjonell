...
**FMN og FAD er koenzymer for mange enzymer, og har som oppgave å overføre hydrogenatomer.** Funksjoner som er avhengig av dette vitaminet er blant annet energiproduksjon i elektrontransportkjeden og regulering/modifisering av andre B-vitaminer ([B6](pyridoksin.qmd), [niacin](niacin.qmd), [folat](folat.qmd) og [B12](kobalamin.qmd)).
