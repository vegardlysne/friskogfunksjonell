...
Omdanningen mellom de ulike formene av vitaminet er avhengig av andre næringsstoffer, blant annet [riboflavin](riboflavin.qmd) og [niacin](niacin.qmd). Fosforyleringsreaksjonene er avhengig av [sink](sink.qmd).
...
PLP er også sentral i glukosemetabolismen, og bidrar til glykogennedbrytningen og nydanning av glukose (glukoneogenesen). B6 er viktig i syntesen og metabolismen av [niacin](niacin.qmd) og [folat](folat.qmd).
