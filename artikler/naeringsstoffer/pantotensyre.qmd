...
Absorbsjonen kan skje aktivt gjennom et natriumavhengig transportprotein som heter SMVT (Natriumavhengig multivitamin transporter), som også sørger for opptak av [biotin](http://www.friskogfunksjonell.no/biotin/ "Biotin, vitamin B7"). Pantotensyre og biotin konkurrerer altså om den samme transportmekanismen, og store doser av det ene vitaminet kan hemme opptaket av det andre. Absorbsjonen kan også skje ved passiv diffusjon.
...
Hovedfunksjonen til CoA er overføring av acyl- og acetylgrupper, noe som gjør molekylet til en svært sentral brikke i kroppens metabolske prosesser. Hovedsakelig er CoA involvert i katabole/nedbrytende prosesser. Blant prosessene som er avhengig av CoA finner vi [sitronsyresyklusen](http://www.friskogfunksjonell.no/sitronsyresyklusen/ "Sitronsyresyklusen"), [β-oksidasjon av fettsyrer](http://www.friskogfunksjonell.no/fettmetabolismen/ "Fettmetabolismen") og [oksidativ nedbrytning av aminosyrer](http://www.friskogfunksjonell.no/proteinmetabolismen/ "Proteinmetabolismen").

![](images/clipboard-3853095687.png)

ACP er som en bestanddel av fettsyre syntase-enzymet viktig for syntese av fettsyreren. Det er også observert at ACP-lignende faktorer spiller en rolle for syntesen og aktivering av en  del andre forbindelser, blant annet [aminosyrene](http://www.friskogfunksjonell.no/protein/) leucin, arginin og metionin, kolesterol, steroidhormoner, [A](http://www.friskogfunksjonell.no/a-vitamin/)- og [D](http://www.friskogfunksjonell.no/d-vitamin/)-vitamin, hemoglobin, [B12](http://www.friskogfunksjonell.no/b12), og nevrotransmitterne acetylkolin, serotonin og melatonin.
