...
Absorbsjonen kan skje aktivt gjennom et natriumavhengig transportprotein som heter SMVT (Natriumavhengig multivitamin transporter), som også sørger for opptak av [biotin](biotin.qmd "Biotin, vitamin B7"). Pantotensyre og biotin konkurrerer altså om den samme transportmekanismen, og store doser av det ene vitaminet kan hemme opptaket av det andre. Absorbsjonen kan også skje ved passiv diffusjon.
...
Hovedfunksjonen til CoA er overføring av acyl- og acetylgrupper, noe som gjør molekylet til en svært sentral brikke i kroppens metabolske prosesser. Hovedsakelig er CoA involvert i katabole/nedbrytende prosesser. Blant prosessene som er avhengig av CoA finner vi [sitronsyresyklusen](../metabolismen/sitronsyresyklusen.qmd "Sitronsyresyklusen"), [β-oksidasjon av fettsyrer](../metabolismen/fettfettsyrenedbrytning.qmd "Fettmetabolismen") og [oksidativ nedbrytning av aminosyrer](../metabolismen/proteinmetabolismen.qmd "Proteinmetabolismen").
