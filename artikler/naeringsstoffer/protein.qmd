...
Aminosyrer kan brytes ned og brukes som energi. Når en aminosyre brytes ned står vi igjen med to deler, et karbonskjelett og aminogruppen. Aminogruppen vil fraktes til leveren og omdannes til urea, som skilles ut i urinen. Karbonskjelettet kan enten oksideres og gå inn i [sitronsyresyklusen](../metabolismen/sitronsyresyklusen.qmd "Sitronsyresyklusen") som substrat i energiproduksjonen, eller det kan være utgangspunkt for [nydanning av glukose](../metabolismen/glukosemetabolismen.qmd "Karbohydratmetabolismen") (glukogene aminosyrer) eller [fettsyrer](../metabolismen/fettsyresyntese.qmd) (ketogene aminosyrer).\
...
Les mer om [proteinmetabolismen](../metabolismen/proteinmetabolismen.qmd "Proteinmetabolismen").
...
En annen ting som er viktig å ta hensyn til ved proteininntak, er [proteinkvaliteten](../proteinkvalitet.qmd "Alt du trenger å vite om proteinkvalitet"). Dette er først og fremst knyttet til innholdet av aminosyrer, fortrinnsvis de essensielle aminosyrene. Dersom det oppstår mangel på en bestemt aminosyre, vil hele proteinsyntesen stoppe opp, og vi vil bli syke.
...
-   [Kan bioaktive peptider være viktig for proteinkvaliteten?](../peptider-helse.qmd)
