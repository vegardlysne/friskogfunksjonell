...
-   Les om proteiner og hvordan de fordøyes og tas opp i [denne artikkelen](../naeringsstoffer/protein.qmd).
...
Glycin kan på sin side, i tillegg til å produseres fra serin, også produseres fra nedbrytning av aminosyren treonin, fra nedbrytningen av [kolin](../bioblikk-kolin.qmd).

Cystein dannes i en reaksjon der homocystein kobles sammen med serin, som du kan lese mer om i artikkelen om [enkarbonmetabolismen](../bioblikk-enkarbonmetabolismen.qmd). Dette forklarer også hvorfor cystein er en betinget essensiell aminosyre, ettersom vi blir avhengig av å få den gjennom kostholdet dersom metionininntaket ikke er tilstrekkelig.

![](images/clipboard-3479256886.png)

## Proteinsyntese

Aminosyrene fraktes fra blodet og inn i [cellene](../fysiologi/cellen.qmd) i vårt DNA, der tre og tre baser koder for en aminosyre
