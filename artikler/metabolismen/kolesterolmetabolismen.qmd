...
Les også artikkelen om [lipoproteinmetabolismen](lipoproteinmetabolismen.qmd "Lipoproteinmetabolismen").

## Produksjon av kolesterol

Kolesterol produseres hovedsakelig i leveren, men de fleste andre celler har også kapasitet til å produsere noe selv. Kolesterol produseres i tre faser, og utgangspunktet er tokarbonenheten Acetyl-CoA. Som vi har sett i artiklene om [glukose](glukosemetabolismen.qmd "Glukosemetabolismen")- og [fettmetabolismen](fettsyrenedbrytning.qmd "Fettsyrenedbrytning – β-oksidasjon") så er acetyl-CoA nedbrytningsproduktet som kan fraktes videre inn i sitronsyresyklusen for videre energiproduksjon. I artikkelen om [ketonmetabolismen](ketonmetabolismen.qmd "Ketonmetabolismen") så vi at acetyl-CoA også er utgangspunktet for produksjon av disse vannløselige energimolekylene.
