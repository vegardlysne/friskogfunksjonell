...
Jeg har tidligere skrevet om hvordan ketonlegemer produseres og forbrennes ([ketonmetabolismen](http://www.friskogfunksjonell.no/ketonmetabolismen/ "Ketonmetabolismen")), så en fullstendig repetisjon er ikke nødvendig. Kort fortalt produseres ketonlegemer fra [nedbrytning av fett](http://www.friskogfunksjonell.no/fettsyrenedbrytning/ "Fettsyrenedbrytning – β-oksidasjon"). Endeproduktet fra fettsyrenedbrytning heter acetyl-CoA. Dette molekylet kan enten metaboliseres videre i [sitronsyresyklusen](http://www.friskogfunksjonell.no/sitronsyresyklusen/ "Sitronsyresyklusen") og [elektrontransportkjeden](http://www.friskogfunksjonell.no/elektrontransportkjeden/ "Elektrontransportkjeden") for å produsere energi, eller kobles sammen med et annet Acetyl-CoA-molekyl og danne ketonlegemer.
...
Oksaloacetat kan produseres fra pyruvat, som er endeproduktet i [glykolysen](http://www.friskogfunksjonell.no/glukosemetabolismen/ "Glukosemetabolismen"). Eventuelt kan vi produsere oksaloacetat ved nedbrytning av glukogene aminosyrer, men først og fremst kommer dette fra nedbrytning av glukose. Tilstrekkelig aktivitet i glykolysen er altså nødvendig for at vi skal kunne utnytte energien fra Acetyl-CoA fullt ut.
...
Alt i alt er det absolutt en plass for ketogene dietter i visse tilfeller, selv om påstanden om optimal fettforbrenning ikke nødvendigvis kan sies å være korrekt rent biokjemisk. Jeg vil personlig ikke anbefale disse diettene på generelt grunnlag, men i mange tilfeller er det heller ikke spesielt mange argumenter for å fraråde det dersom man ønsker å spise slik. Friske personer kan overleve og klare seg fint på et bredt spekter av ulike kosthold, og så lenge man dekker behovene for de ulike [næringsstoffene](http://www.friskogfunksjonell.no/naeringsstoffene/ "Artikkelserie om Næringsstoffene") er jeg av den mening at folk selv bør kunne bestemme hvordan de vil spise. Når det gjelder kostholdsanbefalinger til syke personer, bør dette vurderes i hvert enkelt tilfelle i samråd med behandlende lege.
