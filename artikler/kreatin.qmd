...
Tilskudd av kreatin kan øke de intracellulære nivåene av kreatinfosfat. Dette gjør flere ting. Kreatinfosfat er osmotisk aktivt og øker cellens hydrasjonsgrad. Dette har vært foreslått som mulig mekanisme for muskelvekst gjennom å øke det myonukleære domenets størrelse. Metabolsk stress og effekten av celleswoling, lokale og systemiske vekstfaktorer er et område som får økende interesse, for en kjapp gjennomgang er det verdt å lese: [Metabolsk stress og muskelvekst](http://myrevolution.no/s/metabolsk-stress-og-muskelvekst/).
