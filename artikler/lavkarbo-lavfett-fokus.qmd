...
Men er det sånn at så lenge sammensetningen av hovednæringsstoffene ([fett](naeringsstoffer/fett.qmd), [protein](naeringsstoffer/protein.qmd) og [karbohydrat](naeringsstoffer/karbohydrater.qmd)) passer din kostholdsretning, så er dette det eneste som teller? Hvis vi skal tro på alt vi leser i media, så kan det virke som om mange er av denne oppfatningen. Det er ikke jeg!
...
Setter du sammen kostholdet ditt av gode matvarer som er minst mulig bearbeidede, så er fordelingen mellom de ulike [næringsstoffene](../naeringsstoffer.qmd) i min bok underordnet, og ikke noe du nødvendigvis trenger å tenke så mye på.
...
Ved å velge matvarer av god kvalitet vil du også dekke behovet for alle mikronæringsstoffene. Dette forutsetter selvfølgelig at energiinntaket ditt er tilstrekkelig. Eneste unntak er [D-vitamin](naeringsstoffer/dvitamin.qmd), siden dette er et vitamin vi hovedsakelig produserer selv når vi eksponeres for sollys. Det kan være en fordel å ta tilskudd av dette vitaminet i vinterhalvåret.

Ved å redusere kornforbruket og velge fett av høy kvalitet (ikke varmebehandlede oljer som soya-, solsikke- og maisolje), vil du også oppnå en bedre [balanse mellom omega-3 og omega-6](omega-3-6.qmd), noe som er sentralt når det gjelder å opprettholde en god helse!
