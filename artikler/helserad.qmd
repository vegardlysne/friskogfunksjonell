...
Det er grunn til å hevde at flytende energi i form av brus, juice, saft og lignende gir en svært dårlig metthetsfølelse. Sliter du med å holde vekten, er dette det første du bør [kutte ut av det daglige kostholdet ditt](http://www.friskogfunksjonell.no/bor-du-begrense-inntaket-av-flytende-karbohydrater/ "Bør du begrense inntaket av flytende karbohydrater?"). Mens inntak av raske karbohydrater fra fast føde ofte fører til en kompensasjon i form av redusert energiinntak resten av dagen, viser studier at det motsatte skjer dersom denne energien kommer i flytende form. Energiinntaket resten av dagen forblir like høyt, og i mange tilfeller øker det!

I Helsedirektoratets anbefalinger regnes et glass juice som en av "5 om dagen". Av flere grunner synes vi dette ikke bør være tilfelle. For det første får vi ikke med fiberet som finnes naturlig i frukten, noe som gjør at påvirkningen på blodsukkeret blir mye større. For det andre varmebehandles juicen, slik at mye av [C-vitaminet](http://www.friskogfunksjonell.no/c-vitamin/ "C-vitamin") vil ødelegges, og innholdet blir derfor lavere enn i den opprinnelige frukten. Syreinnholdet vil også være negativt for tannhelsen, og setter et økt krav til munnhygiene! Velg derfor frukt i stedet for fruktjuice.
...
## **6. Øk [aktivitetsnivået](http://www.friskogfunksjonell.no/aktivitetsniva-helse/ "Aktivitetsnivå og helse")**
...
Styrketrening bør være sentralt i ethvert opplegg, nesten uavhengig av målsetning. Frie vekter gir i de fleste tilfeller langt mer effektiv trening enn trening i apparater, siden øvelser med frie vekter stiller større krav til stabilisering og balanse. Dette vil igjen bidra til at denne treningen også i større grad virker skadeforebyggende. Vi anbefaler å finne et program som trener hele kroppen, og fokuserer på store øvelser med frie vekter. For å [bli sterkere](http://www.friskogfunksjonell.no/treningsprogram-1/ "Enkelt treningsprogram for deg som vil bli stor og sterk!") er det viktig at belastningen økes over tid. En metode som kan benyttes til dette er [mengdetrening](http://www.friskogfunksjonell.no/mengdetrening-del-1/ "Bli sterkere med mengdetrening (Del 1)").

En sterk kjernemuskulatur er veldig viktig for å holde kroppen skadefri, og er også sentral når det gjelder idrettsprestasjoner. Vi anbefaler å inkludere øvelser som trener kjernemusklene på den måten de er ment å fungere, nemlig til å motvirke bevegelse. Øvelser som øker denne egenskapen er f.eks. forskjellige plankevarianter. Les mer om basistrening [her](http://www.friskogfunksjonell.no/basistrening/ "Basistrening – bli trent for å trene").

Når det gjelder [kondisjonstrening](http://www.friskogfunksjonell.no/nybegynnerkurs-i-utholdenhetstrening/ "Nybegynnerkurs i utholdenhetstrening"), velger veldig mange å jogge, noe som ikke nødvendigvis er det beste valget. En intervalløkt vil gi en mye større effekt på oksygenopptaket, som er den viktigste faktoren for kondisjonen. En slik økt vil også ta mye kortere tid, og vil enklere kunne inkluderes i en travel hverdag. Lengre joggeturer har også sin plass i et helhetlig opplegg, men husk at dette er en treningsform som sliter mye på kroppen. Spesielt knær og ankler er utsatt, så det kan være en god idé å variere med f.eks. svømming eller sykling.
